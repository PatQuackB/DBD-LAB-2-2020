...
<body>
  ...
  <form class="row g-3 needs-validation" action="{{route('crearNuevoPuesto', $user->id)}}" method="POST">
    ...
    <div class="col-12">
      <button type="submit" id="boton" class="btn btn-primary">Crear Puesto</button>
    </div>
  </form>
  ...
  <div class="col-sm-4">
    <div class="card" style="width: 18rem;">
      <img class="card-img-top" src="../img/puesto.png" alt="Card image cap" width="150" height="300">
      <div class="card-body">
