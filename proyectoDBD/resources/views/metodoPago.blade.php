...
<body class="container-fluid">
  ...
  <div class="form-group" class="required">
    ...
    <div class="form-group">
        <label for="exampleInputUltimosNumerosTarjeta">Numero Tarjeta</label>
        <input type="text" pattern=".{1,25}" class="form-control" name="ultimosNumerosTarjeta" required placeholder="Ingrese el número de tarjeta">
    </div>
    <br>

    <div class="form-group">
        <label for="exampleInputMesVencimiento">Mes vencimiento</label>
        <input type="int" pattern=".{1,25}" class="form-control" name="mesVencimiento" required placeholder="Ingrese el mes de vencimiento de su tarjeta">
    </div>
    <br>

    <div class="form-group">
        <label for="exampleInputAnioVencimiento">Año vencimiento</label>
        <input type="int" pattern=".{1,25}" class="form-control" name="anioVencimiento" required placeholder="Ingrese el año de vencimiento de su tarjeta">
    </div>
    <br>

        <button type="submit" id="submit" class="btn btn-primary">Pagar</button>
    </form>
</div>  
