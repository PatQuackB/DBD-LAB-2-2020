    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav position-absolute end-0">
          <a class="nav-link" id="botonSuperiorRegistro" aria-current="page" href="{{route('regionIndex')}}">Registrarse</a>
  ...
  <div class="container">
    <form action="{{route('userStore')}}" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="password" id="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control" name="contraseniaUsuario" placeholder="Debe contener al menos un número, una letra mayúscula, una letra minúscula, y al menos 8 o más caracteres " required>
      </div>
      <div id="message">
      ...
      <br>
      <button type="submit" id="boton" class="btn btn-primary">Registrarse</button>
    </form>
  </div>
  <!--Pie de página-->
  <footer>
