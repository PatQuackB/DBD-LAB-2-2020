...
<nav class="nav navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="col-sm-4">
      <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="../img/carritoPago.png" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title"> {{$ordenCompra->numeroCompra}}</h5>
          <p class="card-text"></p>
          <p>Fecha compra: {{$ordenCompra->fechaCompra}}</p>
          <p>Monto total: ${{$ordenCompra->montoTotal}}</p>
          </p>

          <a href="/homeBack/{{$user->id}}" id="boton" class="btn btn-primary">Seguir comprando</a>
        </div>
      </div>
    </div>  
